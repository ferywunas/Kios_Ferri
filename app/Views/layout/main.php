...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="/" class="logo d-flex align-items-center">
                ...
                <span class="d-none d-lg-block">Kios Fery</span>
            </a>
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                        ...
                        <span class="d-none d-md-block dropdown-toggle ps-2">Kakak Fery Wunas</span>
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="/produk/supplier">
                            <i class="bi bi-circle"></i><span>Supplier</span>
                        </a>
                    </li>
                    <li>
                        <a href="/transaksi/pembelian">
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1><?= $this->renderSection('subtitile'); ?></h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/">Home</a></li>
                    <li class="breadcrumb-item active"><?= $this->renderSection('subjudul'); ?></li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
